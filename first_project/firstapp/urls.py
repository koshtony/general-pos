...
from . import views
from .views import StocksCreateView,ShopsCreateView,StocksUpdateView,ShopsListView
urlpatterns = [
    ...
    path('shops/list/<int:pk>',views.ShopsUpdateView.as_view(),name="firstapp-updateshops"),
